 ...
 * @author Heitor Lopes
 */
public class TIEstoque extends javax.swing.JFrame {
    ...
    public static void atualizarTabela() {
        ...
        for (Produtos produto : produtos) {
            tabelaEstoque.setValueAt(produto.getCodigo(), cont, 0);
            tabelaEstoque.setValueAt(produto.getDescricao(), cont, 1);
            tabelaEstoque.setValueAt(produto.getQuantidade(), cont, 2);
            tabelaEstoque.setValueAt(produto.getPreco(), cont, 3);
            tabelaEstoque.setValueAt(produto.getFornecedor(), cont, 4);
            tabelaEstoque.setValueAt(produto.getEstoque(), cont, 5);
            cont++;
        }
    ...
    private void initComponents() {
        ...
        titulo.setText("Escolha um Estoque");
        ...
        mid.setLayout(new java.awt.GridLayout(1, 0));

        midTop.setBackground(new java.awt.Color(118, 180, 247));
        java.awt.FlowLayout flowLayout1 = new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT, 5, 100);
        ...
        tabelaEstoque.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição", "Quantidade", "Preço", "Fornecedor", "Loja"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TIEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
