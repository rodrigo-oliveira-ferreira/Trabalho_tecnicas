 ...
 * @author Hauz
 */
public class MudançaVendas extends javax.swing.JFrame {

    /**
     * Creates new form NovoJFrame2
     */
    public MudançaVendas() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       PerguntaConfirmar2Vendas c = new PerguntaConfirmar2Vendas();
       setVisible(false);
       c.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MudançaVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MudançaVendas().setVisible(true);
            }
        });
    }
